    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Tambah Post Baru</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.admin-posts.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    // DOM loaded, initializing TinyMCE
