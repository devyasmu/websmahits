                ...
                <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('answer') is-invalid @enderror" 
                                  id="answer" name="answer" rows="15">{{ old('answer', $faq->answer) }}</textarea>
                        @error('answer')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('category') is-invalid @enderror" 
                            ...
                            <option value="admission" {{ old('category', $faq->category) == 'admission' ? 'selected' : '' }}>Penerimaan Siswa</option>
                            <option value="academic" {{ old('category', $faq->category) == 'academic' ? 'selected' : '' }}>Akademik</option>
                            <option value="tuition" {{ old('category', $faq->category) == 'tuition' ? 'selected' : '' }}>Biaya Pendidikan</option>
                            <option value="facilities" {{ old('category', $faq->category) == 'facilities' ? 'selected' : '' }}>Fasilitas</option>
                            <option value="programs" {{ old('category', $faq->category) == 'programs' ? 'selected' : '' }}>Program</option>
                            <option value="registration" {{ old('category', $faq->category) == 'registration' ? 'selected' : '' }}>Pendaftaran</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('priority') is-invalid @enderror" 
                                    ...
                                    <option value="low" {{ old('priority', $faq->priority) == 'low' ? 'selected' : '' }}>Rendah</option>
                                    <option value="normal" {{ old('priority', $faq->priority) == 'normal' ? 'selected' : '' }}>Normal</option>
                                    <option value="high" {{ old('priority', $faq->priority) == 'high' ? 'selected' : '' }}>Tinggi</option>
                                    <option value="urgent" {{ old('priority', $faq->priority) == 'urgent' ? 'selected' : '' }}>Mendesak</option>
                                </select>
                                @error('priority')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
