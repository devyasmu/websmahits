...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.admin-programs.update', ['program' => $program->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-3">
                        <label for="title" class="form-label">Judul Program <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="excerpt" class="form-label">Ringkasan Program</label>
                        <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                  id="excerpt" name="excerpt" rows="3">{{ old('excerpt', $program->excerpt) }}</textarea>
                        @error('excerpt')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="content" class="form-label">Deskripsi Program <span class="text-danger">*</span></label>
                        <textarea class="form-control @error('content') is-invalid @enderror" 
                                  id="content" name="content" rows="15" required>{{ old('content', $program->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                           id="price" name="price" value="{{ old('price', $program->price) }}" min="0" step="1000">
                                </div>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('duration') is-invalid @enderror" 
                                       id="duration" name="duration" value="{{ old('duration', $program->duration) }}" placeholder="Contoh: 3 bulan, 1 tahun">
                                @error('duration')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" 
                                           value="1" {{ old('is_featured', $program->is_featured) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.admin-programs.index') }}" class="btn btn-secondary me-2">
        ...
        templates: [
            {
                ...
                description: 'Template untuk program',
                content: '<h2>Nama Program</h2><p>Deskripsi singkat program...</p><h3>Tujuan Program</h3><p>Tujuan dan manfaat program...</p><h3>Materi Pembelajaran</h3><ul><li>Materi 1</li><li>Materi 2</li><li>Materi 3</li></ul><h3>Persyaratan</h3><p>Persyaratan untuk mengikuti program...</p>'
            },
            {
